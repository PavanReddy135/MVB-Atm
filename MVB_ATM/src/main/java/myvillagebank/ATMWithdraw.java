        ...
        try (Connection con = DriverManager.getConnection(url, user, pword)) {
            ...
            if (rs.next()) {
                ...
                if (amount > balance) {
                    ...
                    pw.println("<h2 style='color:red;'>Insufficient Balance!</h2>");
                    ...
                    if (rows > 0) {
                        ...
                        transStmt.setString(4, "ATM WITHDRAW");
                        ...
                        pw.println("<h2>Withdraw Successful!</h2>");
                        ...
                        pw.println("<h2 style='color:red;text-align:center;'>Failed to withdraw money. Try again.</h2>");
                    }
                }
            } else {
